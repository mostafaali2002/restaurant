...
class BurgerDetails3 extends StatefulWidget {
  const BurgerDetails3({super.key});

  @override
  State<BurgerDetails3> createState() => _BurgerDetailsState();
}

class _BurgerDetailsState extends State<BurgerDetails3> {
  double price = 15.00;
  int counter = 1;
  @override

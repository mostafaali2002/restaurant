...
class IceCreamDetails2 extends StatefulWidget {
  const IceCreamDetails2({super.key});

  @override
  State<IceCreamDetails2> createState() => _BurgerDetailsState();
}

class _BurgerDetailsState extends State<IceCreamDetails2> {
  double price = 5.00;
  int counter = 1;
  @override
        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const FoodNameAndRate(foodName: "Straweberry", foodRate: "5.0"),

...
class PizzaDetails2 extends StatefulWidget {
  const PizzaDetails2({super.key});

  @override
  State<PizzaDetails2> createState() => _BurgerDetailsState();
}

class _BurgerDetailsState extends State<PizzaDetails2> {
  double price = 16.00;
  int counter = 1;
  @override

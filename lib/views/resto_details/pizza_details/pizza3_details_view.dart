...
class PizzaDetails3 extends StatefulWidget {
  const PizzaDetails3({super.key});

  @override
  State<PizzaDetails3> createState() => _BurgerDetailsState();
}

class _BurgerDetailsState extends State<PizzaDetails3> {
  double price = 16.00;
  int counter = 1;
  @override
        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const FoodDetailsImage(imagePath: "assets/images/bigpizza.png"),

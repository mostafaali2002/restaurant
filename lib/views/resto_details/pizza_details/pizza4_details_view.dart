...
class PizzaDetails4 extends StatefulWidget {
  const PizzaDetails4({super.key});

  @override
  State<PizzaDetails4> createState() => _BurgerDetailsState();
}

class _BurgerDetailsState extends State<PizzaDetails4> {
  double price = 16.00;
  int counter = 1;
  @override
